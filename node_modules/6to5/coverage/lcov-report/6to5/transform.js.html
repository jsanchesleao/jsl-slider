...
<html lang="en">
<head>
    <title>Code coverage report for 6to5/transform.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">6to5/transform.js</span></h1>
    <h2>
        
        Statements: <span class="metric">96.55% <small>(56 / 58)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">96.55% <small>(56 / 58)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">6to5/</a> &#187; transform.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >      err.message += util.codeFrame(execCode);</span>
...
&nbsp;
    ...
    var expectResult = generate(expectCode, expectAst);
...
&nbsp;
    _.each(task.sourceMappings, function (mapping, i) {
      var gen  = mapping.generated;
      var orig = mapping.original;
&nbsp;
      var pos = consumer.originalPositionFor(gen);
      assert.equal(pos.line + ":" + pos.column, orig.line + ":" + orig.column);
    });
  }
};
&nbsp;
