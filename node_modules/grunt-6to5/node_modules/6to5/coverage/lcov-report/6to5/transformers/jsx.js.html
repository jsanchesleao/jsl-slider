...
<html lang="en">
<head>
    <title>Code coverage report for 6to5/transformers/jsx.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">6to5/transformers/jsx.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">6to5/transformers/</a> &#187; jsx.js</div>
</div>
<div class="body">
...
&nbsp;
  ...
  _.each(node.leadingComments, function (comment) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (matches) jsx = matches[1];
  });
&nbsp;
