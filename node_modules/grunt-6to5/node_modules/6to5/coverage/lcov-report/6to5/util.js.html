...
<div class="header high">
    ...
    <h2>
        ...
        Branches: <span class="metric">91.43% <small>(64 / 70)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">95.45% <small>(21 / 22)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">95.6% <small>(152 / 159)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
<span class="cline-any cline-yes">2335</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">7012</span>
<span class="cline-any cline-yes">7012</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var estraverse = require("estraverse");
...
&nbsp;
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (id.type === "ObjectPattern") {
      _.each(id.properties, function (prop) {
        search.push(prop.value);
      });
    } else {
<span class="cstat-no" title="statement not covered" >      throw new Error("unknown node " + id.type);</span>
    }
  }
&nbsp;
  return ids;
...
<span class="cstat-no" title="statement not covered" >    throw new Error("no templates directory - this is most likely the result" +</span>
